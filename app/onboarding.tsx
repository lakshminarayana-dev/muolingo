    ...
    <SafeAreaView style={{ flex: 1 }} className="bg-white">
      ...
      <View className="flex-1 items-center justify-center">
        <Image
          ...
          resizeMode="contain"
        />
        <View className="absolute left-4 bottom-20 rounded-[20px] px-3.5 py-2 border-[1.5px] border-border bg-white shadow-bubble elevation-3">
          <Text className="font-poppins-medium text-sm text-text-primary">Hello!</Text>
        </View>
        <View className="absolute right-4 top-12.5 rounded-[20px] px-3.5 py-2 border-[1.5px] border-border bg-white shadow-bubble elevation-3">
          <Text className="font-poppins-medium text-sm text-text-primary">¡Hola!</Text>
        </View>
        <View className="absolute right-5 top-40 rounded-[20px] px-3.5 py-2 border-[1.5px] border-border bg-white shadow-bubble elevation-3">
      ...
      <View className="px-6 pb-8">
        <TouchableOpacity
          className="bg-lingua-purple rounded-[28px] h-14.5 flex-row items-center justify-center gap-2"
          activeOpacity={0.85}
          onPress={() => router.push("/(auth)/sign-up")}
        >
          <Text className="font-poppins-semibold text-base text-white">Get Started</Text>
          <Text className="font-poppins-bold text-[24px] leading-6.5 text-white">›</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
